...
public class Camera {
    ...
    public Point location; //location is a point in the center of the camera
    Point screenPos;
     ...
     * @param height
     */
    public void setScreenArea(Point screenPos,int width,int height){
        this.width=width;
        this.height=height;
    ...
    public void setScreenArea(Rectangle area){
        ...
        this.screenPos=new Point(area.x,area.y);
        setAreaMode(AREA_MODE.independent);
    }
    ...
    private static class Proportional extends AreaMode {
        ...
        @Override
        public void instanceUpdateArea(Camera observer) {
            observer.CameraArea=new Rectangle(observer.screenPos.x,observer.screenPos.y,Math.round(observer.observer.getWidth()*observer.proportionX),Math.round(observer.observer.getHeight()*observer.proportionY));
        }
    }
    ...
    private static class Independent extends AreaMode {
        ...
        @Override
        public void instanceUpdateArea(Camera observer) {
            observer.CameraArea=new Rectangle(observer.screenPos.x,observer.screenPos.y,observer.width,observer.height);
        }
    }
